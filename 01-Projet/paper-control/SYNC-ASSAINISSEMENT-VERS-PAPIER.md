...
- Le premier dispatch de replay PPR (`978593`) est une trace technique non reportable : il a échoué avant toute lecture de l'évaluation, parce que le manifeste de dispatch hashé était stagé hors du checkout Télécom et que le wrapper ne recevait pas ce chemin. Aucun fichier `ppr_final`, ranking ou score B1-r1 n'a été produit. Le correctif est testé et conserve le même manifeste parent et les mêmes champions gelés. Seule formulation autorisée à ce stade : « Les configurations PPR ont été sélectionnées sur les cinq folds groupés de l’entraînement puis gelées avant l’évaluation. » Ne pas écrire un score PPR B1-r1 ni comparer PPR à cosine ou LightGCN.
