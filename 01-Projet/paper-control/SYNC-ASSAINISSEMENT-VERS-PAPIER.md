...
- Le gate de budget est maintenant prêt : `scripts/114_audit_b2_e030_context.py`, SHA `a5ac79c3d524da87336b58027d6e2b61d4b5d3706b6df4a03128732d44440283`, calcule les tokens du vrai message chat du tokenizer local et la réserve de sortie avant tout appel. Il émet un reçu hashé sans contenu de fiche ; toute incompatibilité bloque la soumission plutôt que de transformer silencieusement un échec technique en jugement. Deux tests dédiés passent. Aucun score E030 n'est encore produit.
