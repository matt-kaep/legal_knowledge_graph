...
- La campagne urgente du papier est maintenant séparée de l'ablation exhaustive : `G6-citation-AA-knn5` est la configuration principale présélectionnée, non un champion confirmé des onze graphes. Au contrôle courant du 7 septembre, 115/120 tâches CV G6 ont un reçu complet ; cinq tâches restent actives (`984366_235`, `984366_236`, `984395_237`, `984395_238`, `984395_239`). Les autres graphes sont différés, sans suppression ni modification des artefacts B1-r2. Aucun score G6 partiel n'est transmissible.
...
- Cosine et PPR A3 disposent maintenant d'un export paper-ready r3 terminé sur CPU (`Slurm 984031`, 4 s), sans relancer retrieval : `.../_campaign_b1_a3_paper_ready_existing_retrieval_r3_20260907/depth_curves/depth_curves_manifest.json`, SHA-256 `34eb87c52ece513df0de78d904a3075f8c941720189ab14298a09ab9f8bcf1bd`. Le manifeste source est `05-Technique/benchmark/etape1_embedding_pur/configs/paper_ready_existing_retrieval_a3_r3.json`, SHA-256 `670f44bfcf10ba6460678632ecd9fde0349d3eca0062b38c2b51d98606e9c83f`. À reprendre : `ranking_metrics_at_10.csv` SHA-256 `fa7abb380c984b652d890576ca2e238f9a7110b9c368b8c0541f152f1d47d5a2`, `depth_curves.csv` SHA-256 `c188b2faabf6951c761b587fbfb73aef07b9bd79da791dd9dfffc319e3e52b93`, PNG `164bb425c4e8765111453eff4f94cb76dbc4f3fc42beba18867d7a699cb38a21`, PDF `0e23fe765569e0dffd09e8489ee45c51362bc60fffee46025f46156dbaab4449`. Les quatre rankings couvrent 754 questions par tâche, sans doublon ni candidat hors A3 ; la dispersion est bien entre graines. Cosine/PPR sont utilisables pour les métriques exactes internes. Afficher le temps PPR seulement (Articles `0,197386` s/question, JP `0,187228` s/question) ; le temps cosine par question reste non mesuré. Les sorties r2 sont conservées mais non reportables ; E017/E021/E022 restent exclus.
- E027 (LLM direct) est maintenant figée, mais **aucun appel n'a encore été exécuté** : `05-Technique/benchmark/etape1_embedding_pur/configs/b2_direct_llm_a3_v1.json`, SHA-256 `a6da87fca6658ae33b73da22b34bd66f061a8a20d9c492e7ae9e891fd35905d7`. Le modèle Gemma figé à température 0 reçoit seulement une question et un prompt fixe distinct Articles/JP ; il ne reçoit ni graphe, ni vivier, ni corpus, ni outil. La résolution vers A3 est strictement syntaxique, toute référence inconnue/ambiguë/dupliquée/malformée comptant zéro à son rang d'origine. Le lancement attend la fin prouvée du parcours GPU G6. E029 doit utiliser les textes intégraux non tronqués ; son audit de contexte v3 est invalide et ne produit aucun résultat : il comptait les deux clés d'un `BatchEncoding` au lieu des tokens réels. Un correctif testé exige un nouvel audit immuable avant tout manifeste, appel LLM ou tableau de reranking. E030 reste exploratoire jusqu'à l'accord avocat et ne doit pas être confondu avec le reranking.
- Mise à jour E029, sans résultat de reranking à reprendre : l'audit v4 réel est terminé (`984753`, `0:0`, SHA-256 `91361409505268feb71557241a507d2cbeeb6e63db4f988325995ec5aea31170`). Sur 40 conditions × 754 questions, il n'autorise que 15 conditions à textes intégraux ; les 25 autres devront rester `--`, sans troncature. Le manifeste successeur hashé `configs/b2_reranking_comparable_a3_fulltext_v1.json` référence cette matrice. Le modèle reranker ne sera pas appelé avant la voie G6 complète ; rien de cette préparation ne doit être inséré dans le papier à ce stade.
- Mise à jour G6, toujours sans score à reprendre : la CV G6 est complète (120/120 reçus hash-validés), puis agrégée (`984801`, reçu `2d525254b10e263ff3f25ac4bc8e2e4c9c56b974d71f0653bfc45276a5d13fab`) et gelée sur train/CV (`984806`, `afa4aef329ff833c2199af7086e359505575b89dbe0a26f6c39863bccd3884b8`). Les configurations gelées sont K=2 / epoch 9 pour Articles et K=3 / epoch 5 pour JP, avec lr=0,0005 et lambda=0,5. Les trois replays finals sont en cours (`984807`) ; aucun ranking ni métrique des 754 questions ne peut encore être inséré dans le papier.
- Incident technique G6, sans effet sur les résultats : le job de replay `984807` a échoué avant entraînement, ranking ou lecture de l'évaluation car son répertoire temporaire ne contenait pas la projection positive LightGCN A3 requise. Aucun score n'a été produit. A a corrigé ce staging, ajouté un test de régression (suite complète : 353 tests) et créé un manifeste successeur hashé (`fa6f4d61629ab6b8d4c19fe077098a00081fb7515eeb7e52e4a9f4b557bb4d73`) avec un nouveau répertoire de sortie, sans modifier l'agrégation ou le gel train/CV. Le rerun final reste en attente ; ne rien insérer dans le papier.
