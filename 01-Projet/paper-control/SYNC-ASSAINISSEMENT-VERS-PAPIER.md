...
- La campagne urgente du papier est maintenant séparée de l'ablation exhaustive : `G6-citation-AA-knn5` est la configuration principale présélectionnée, non un champion confirmé des onze graphes. Au 7 septembre, 67/120 tâches CV G6 ont un reçu valide ; les 30 tâches B1-r2 soumises (indices 187--216 ; jobs `983938`, `983943`, `983962`, `983966`, `983989`, `984034`) sont toutes G6, avec 8 GPU actifs et 22 tâches G6 en attente du quota. Les autres graphes sont différés, sans suppression ni modification des artefacts B1-r2.
...
- E027 (LLM direct) est maintenant figée, mais **aucun appel n'a encore été exécuté** : `05-Technique/benchmark/etape1_embedding_pur/configs/b2_direct_llm_a3_v1.json`, SHA-256 `a6da87fca6658ae33b73da22b34bd66f061a8a20d9c492e7ae9e891fd35905d7`. Le modèle Gemma figé à température 0 reçoit seulement une question et un prompt fixe distinct Articles/JP ; il ne reçoit ni graphe, ni vivier, ni corpus, ni outil. La résolution vers A3 est strictement syntaxique, toute référence inconnue/ambiguë/dupliquée/malformée comptant zéro à son rang d'origine. Le lancement attend la fin du parcours GPU G6 pour ne pas le ralentir. E029 possède ses viviers réels Cosine/PPR mais est bloquée formellement dans `05-Technique/benchmark/etape1_embedding_pur/configs/b2_reranking_comparable_a3_preflight_v1.json` : les prompts à textes complets ne rentrent pas uniformément dans la fenêtre de contexte. Aucun résultat de reranking ne doit être repris avant qu'un budget textuel commun soit validé et qu'un manifeste successeur ait régénéré les viviers. E030 reste exploratoire jusqu'à l'accord avocat et ne doit pas être confondu avec le reranking.
