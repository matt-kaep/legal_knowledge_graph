...
- Le gel versionné des jobs est également prêt : `scripts/111_freeze_b2_e030_judge_jobs.py`, SHA `8dc3b59bc12bc9f5e0e4c48bbfb0032821156b9dc278a8055e10dee592c43ba3`. À partir d’un ranking final explicitement gelé, il impose 10 positions par question, A3 et les cartes candidate comme sources hashées, puis produit une liste immuable ; il ne rend toujours visible au juge que question + `texte`/`synthese`. Les 7 tests E030 ciblés et la suite complète (`400 passed`) sont verts. Il reste à lier les sources E029 achevées, le snapshot/tokenizer et le budget dans le manifeste d’exécution, puis à soumettre les appels.
