...
- E027 est soumis une seule fois : `984939` pour les Articles et `984940` pour la jurisprudence, en attente de ressources L40S au moment de cette transmission. Le modèle direct ne voit que la question et son prompt fixe ; E029 reste une expérience de reranking distincte à texte intégral, dont 15 conditions sont compatibles et 25 doivent apparaître `--`. E030 demeure exploratoire jusqu'à l'audit avocat.
