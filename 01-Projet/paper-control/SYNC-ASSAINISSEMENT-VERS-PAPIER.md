...
## Transmission prioritaire — résultats exacts G6 disponibles ; LLM direct prêt
...
- E027 est soumis une seule fois : `984939` pour les Articles et `984940` pour la jurisprudence, en attente de ressources L40S au moment de cette transmission. Le modèle direct ne voit que la question et son prompt fixe. E029 reste une expérience de reranking distincte à texte intégral : 15 conditions cosine/PPR sont déjà compatibles et 25 doivent apparaître `--`; le préflight G6 CPU `984986` est soumis sous le manifeste SHA-256 `0e6ec4012c306a74d43f5869f4552b655b8a16e3d59c003f09c7eff6776e8120`, sans appel LLM. Il conserve séparément les graines 42/43/44 et n'est pas un résultat à reprendre. E030 a maintenant un contrat préparatoire distinct, mais aucune liste top-10, modèle ou score n’est gelé ; il n’y a donc aucun résultat de juge à reprendre. Tout score futur demeure exploratoire jusqu'à l'audit avocat.
