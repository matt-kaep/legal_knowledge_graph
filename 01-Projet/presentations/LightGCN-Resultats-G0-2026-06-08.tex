...
\begin{frame}{L'argument central : décomposition de l'ablation}
  ...
  \begin{tabular}{@{}l c l@{}}
    ...
    \;\;\;\; + apprentissage (BPR cosinus) & \textbf{0,704} & \textcolor{ok}{\textbf{+0,051} = apport de l'APPRENTISSAGE} \\
    \bottomrule
  \end{tabular}
  \end{center}
  ...
  \footnotesize
  \vspace{0.3em}
  \textit{Apprentissage \textbf{validé sur 3 seeds} : $0{,}704 \pm 0{,}007$, $\Delta$ toujours positif ($+0{,}045$ à $+0{,}059$). La victoire vs PPR (ligne } $K{=}2$ \textit{ figé, 0,653) est déterministe.}
\end{frame}
...
\begin{frame}{Le grand tableau global — articles (cohorte 971, $K{=}10$)}
  ...
  \begin{tabular}{@{}l r r | r r@{}}
    ...
    \rowcolor{accentsoft} \textbf{LightGCN $K{=}2$ entraîné} & 0,704 & \textbf{0,532} & 0,326 & 0,356 \\
    \bottomrule
  \end{tabular}
  \end{center}
...
\begin{frame}{Le grand tableau global — JP}
  ...
  \begin{tabular}{@{}l r r r@{}}
    ...
    \rowcolor{accentsoft} LightGCN $K{=}2$ entraîné & 0,429 & 0,446 & 0,309 \\
    \bottomrule
  \end{tabular}
  \end{center}
