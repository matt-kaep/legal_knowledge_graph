...
\begin{frame}{Roadmap actualisée -- 21 paliers, état au 9 juin}
  ...
  \begin{tabular}{@{}c p{8.8cm} l@{}}
    ...
    \midrule
    \rowcolor{green!10}
    19 & \textbf{LightGCN multi-seed} + régime D (supervision JP) + $G_0 \to V_1$    & \textcolor{accent}{\textbf{S11--S12}} \\
    \rowcolor{green!10}
...
\begin{frame}{Tableau global -- ARTICLES (cohorte 971, $K{=}10$)}
  ...
  \begin{tabular}{@{}l | r r r r r | r r r r r@{}}
    ...
    \textbf{LightGCN $K{=}2$ entraîné}
     & 0,705 & 0,739 & \textbf{0,496} & \textbf{0,533} & 0,592
...
\begin{frame}{LightGCN -- en une diapo}
  ...
  \textbf{déterministe} (aucun apprentissage). Le gain de l'entraînement ($+0{,}052$
  sur M1 strict) est \textbf{single-seed, hyperparams non tunés} $\to$ à valider multi-seed.}
\end{frame}
...
\begin{frame}{LightGCN -- décomposition de l'ablation (M1 strict articles)}
  ...
  \begin{tabular}{@{}l c l@{}}
    ...
    \;\;\;\; + apprentissage (BPR cosinus) & $\mathbf{0{,}705}$
    & \textcolor{ok}{\textbf{$+0{,}052$ = apport de l'APPRENTISSAGE}} \\
    \bottomrule
  \end{tabular}
  \end{center}

  \vspace{0.6em}
  \keybox{Chaque étage \textbf{ajoute}. Le graphe de citations
  apporte massivement au sémantique pur ; l'apprentissage ajoute encore par-dessus.}
...
\begin{frame}{LightGCN -- limites honnêtes \& suite}
  ...
  \begin{enumerate}\setlength{\itemsep}{0.1em}
    \item Valider l'entraînement \textbf{multi-seed} (3 seeds, mean$\pm$range) -- en cours.
