...
def create_manifest(
    *,
    ...
    payload: dict[str, Any] = {
        "manifest_id": "b2-e030-llm-as-a-judge-a3-retry-v3-preflight-r4-2026-09-09",
        "campaign_id": "b2-llm-as-a-judge-a3-retry-v3-preflight-r4-2026-09-09",
        ...
        "outputs": {
            "root": "doctrine_v3plus_bench/_campaign_b2_e030_a3_retry_v3_r4_20260909",
            "immutable": True,
        },
        "retry_policy": {
